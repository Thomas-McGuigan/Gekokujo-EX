...
common_gekokujo_equip = (ti_on_agent_spawn, 0, 0, [],
	[
		...
		(else_try),
			#same setup as mens_clothes
			(this_or_next|eq, ":troop_no", "trp_hired_gunner"), 
		...
		#START: ninja disguises
		(try_begin),
            (this_or_next|eq, ":troop_no", "trp_hired_agent"), 
            (eq, ":troop_no", "trp_female_agent"),
			...
			(store_random_in_range, ":troop_seed", 1, 5), #roll the dice
			(store_random_in_range, ":clothes_seed", 1, 7), #roll the dice
			(try_begin), #check the results and assign the new equipment
				(eq, ":troop_seed", 1), #1/4 peasant
				(agent_equip_item,":agent_no","itm_gekokujo_sugegasa_1", 4),
				(try_begin),
					(eq, ":clothes_seed", 1), 
					(agent_equip_item,":agent_no","itm_gekokujo_kimono_1_1"),
				(else_try),
				...
				(try_end),
			(else_try),
				(eq, ":troop_seed", 2), #1/4 unarmored samurai
				(try_begin),
					(eq, ":clothes_seed", 1), 
					(agent_equip_item,":agent_no","itm_gekokujo_haori_1"),
				(else_try),
				...
				(try_end),
			(else_try),
				(eq, ":troop_seed", 3), #1/4 monk
				(agent_equip_item,":agent_no","itm_gekokujo_kimono_2_monk"),
				(agent_equip_item,":agent_no","itm_gekokujo_monk_headwrap"),
			(else_try),
				#(eq, ":troop_seed", 4), #1/4 townswoman
				(try_begin),
					(eq, ":clothes_seed", 1), 
					(agent_equip_item,":agent_no","itm_gekokujo_kimono_3_1"),
				(else_try),
...
common_start_deathcam = (
    ...
    [
		...
		#gekokujo archers don't charge end
   ]
)
...
#         (tutorial_box, "str_trainer_help_2", "@Tutorial"),
  ...
  (
    ...
    [
      (16, mtef_visitor_source|mtef_team_0,af_override_everything,aif_start_alarmed,1,[itm_gekokujo_practice_katana,itm_gekokujo_sandal_2]),
      (17, mtef_visitor_source|mtef_team_1,af_override_everything,aif_start_alarmed,1,[itm_gekokujo_practice_jo,itm_gekokujo_sandal_2]),
      (18, mtef_visitor_source|mtef_team_2,af_override_everything,aif_start_alarmed,1,[itm_gekokujo_practice_jo,itm_gekokujo_sandal_2]),
      (19, mtef_visitor_source|mtef_team_3,af_override_everything,aif_start_alarmed,1,[itm_gekokujo_practice_nodachi,itm_gekokujo_sandal_2]),
  ...
  (
    ...
    "Training.",
    [
      (0,mtef_visitor_source|mtef_team_0,af_override_everything,aif_start_alarmed,1,[itm_gekokujo_practice_jo]),
      (1,mtef_visitor_source|mtef_team_1,af_override_everything,aif_start_alarmed,1,[itm_gekokujo_practice_jo]),
      (2,mtef_visitor_source|mtef_team_1,af_override_everything,aif_start_alarmed,1,[itm_gekokujo_practice_jo]),
      (3,mtef_visitor_source|mtef_team_1,af_override_everything,aif_start_alarmed,1,[itm_gekokujo_practice_jo]),
      (4,mtef_visitor_source|mtef_team_1,af_override_everything,aif_start_alarmed,1,[itm_gekokujo_practice_jo]),
...
#      (ti_before_mission_start, 0, 0, [], [(set_rain, 1,100)]),
  ...
  (
    ...
    [
      (0,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_hakama_1]),
      (1,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[itm_gekokujo_kanabo_practice, itm_gekokujo_hakama_1]),
      (2,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_naginata,itm_gekokujo_hakama_1]),
      (3,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yari,itm_gekokujo_hakama_1]),
      (4,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows, itm_gekokujo_practice_wakizashi, itm_gekokujo_hakama_1]),
      (5,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_katana,itm_gekokujo_hakama_1]),
      (6,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_nodachi,itm_gekokujo_hakama_1]),
      (7,mtef_visitor_source|mtef_team_0,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yari,itm_gekokujo_hakama_1]),

      (8,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_practice_wakizashi, itm_gekokujo_hakama_2]),
      (9,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yari,itm_gekokujo_hakama_2]),
      (10,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_nodachi,itm_gekokujo_hakama_2]),
      (11,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_katana,itm_gekokujo_hakama_2]),
      (12,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_hakama_2]),
      (13,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_naginata,itm_gekokujo_hakama_2]),
      (14,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_gekokujo_kanabo_practice,itm_gekokujo_hakama_2]),
      (15,mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_katana,itm_gekokujo_hakama_2]),

      (16,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_hakama_3]),
      (17,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_nodachi,itm_gekokujo_hakama_3]),
      (18,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_gekokujo_kanabo_practice,itm_gekokujo_hakama_3]),
      (19,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yari,itm_gekokujo_hakama_3]),
      (20,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_practice_wakizashi, itm_gekokujo_hakama_3]),
      (21,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_katana,itm_gekokujo_hakama_3]),
      (22,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_naginata,itm_gekokujo_hakama_3]),
      (23,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yari,itm_gekokujo_hakama_3]),

      (24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_hakama_4]),
      (25,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_nodachi,itm_gekokujo_hakama_4]),
      (26,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_kanabo_practice,itm_gekokujo_hakama_4]),
      (27,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yari,itm_gekokujo_hakama_4]),
      (28,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_practice_wakizashi, itm_gekokujo_hakama_4]),
      (29,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_katana,itm_gekokujo_hakama_4]),
      (30,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_naginata,itm_gekokujo_hakama_4]),
      (31,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yari,itm_gekokujo_hakama_4]),
#32
      (32, mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_nodachi,itm_gekokujo_hakama_1]),
      (33,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_jo,itm_gekokujo_haori_5]),
      (34,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_katana,itm_gekokujo_hakama_2]),
      (35,mtef_visitor_source|mtef_team_4,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yari,itm_gekokujo_hakama_3]),
      (36, mtef_visitor_source|mtef_team_1,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_practice_wakizashi,itm_gekokujo_haori_1]),
      (37,mtef_visitor_source|mtef_team_2,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_naginata,itm_gekokujo_hakama_4]),
      (38,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_kanabo_practice,itm_gekokujo_hakama_5]),
      (39,mtef_visitor_source|mtef_team_4,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_katana,itm_gekokujo_hakama_6]),
#40-49 not used yet
      #(24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_hakama_4]),
      #(24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_nodachi,itm_gekokujo_hakama_4]),
      #(24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_nodachi,itm_gekokujo_hakama_4]),
      #(24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yari,itm_gekokujo_hakama_4]),
      #(24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_practice_wakizashi, itm_gekokujo_hakama_4]),
      #(24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_katana,itm_gekokujo_hakama_4]),
      #(24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_nodachi,itm_gekokujo_hakama_4]),
      #(24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yari,itm_gekokujo_hakama_4]),
      #(24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_hakama_4]),
      #(24,mtef_visitor_source|mtef_team_3,af_override_all,aif_start_alarmed,1,[itm_gekokujo_practice_yumi,itm_gekokujo_practice_arrows,itm_gekokujo_hakama_4]),

	  #gekokujo 3.0 arena spectators
      (40,mtef_visitor_source,af_override_all,0,1,[itm_gekokujo_hakama_1]),
      (41,mtef_visitor_source,af_override_all,0,1,[itm_gekokujo_hakama_2]),
      (42,mtef_visitor_source,af_override_all,0,1,[itm_gekokujo_hakama_3]),
      (43,mtef_visitor_source,af_override_all,0,1,[itm_gekokujo_hakama_4]),
      (44,mtef_visitor_source,af_override_all,0,1,[itm_gekokujo_hakama_5]),
      (45,mtef_visitor_source,af_override_all,0,1,[itm_gekokujo_hakama_6]),
      (46,mtef_visitor_source,af_override_all,0,1,[itm_gekokujo_haori_1]),
      (47,mtef_visitor_source,af_override_all,0,1,[itm_gekokujo_haori_2]),
      (48,mtef_visitor_source,af_override_all,0,1,[itm_gekokujo_haori_3]),
      (49,mtef_visitor_source,af_override_all,0,1,[itm_gekokujo_haori_4]),
...
#used for torunament master scene
      ...
      (56, mtef_visitor_source|mtef_team_0, af_override_all, aif_start_alarmed, 1, [itm_gekokujo_practice_katana, itm_gekokujo_haori_1]),
      (57, mtef_visitor_source|mtef_team_0, af_override_all, aif_start_alarmed, 1, [itm_gekokujo_practice_katana, itm_gekokujo_haori_1]),
    ],
    tournament_triggers
  ),
...
##  ),
  ...
  (
    ...
    [
        ...
        (0,mtef_visitor_source,af_override_everything,0,1,[itm_gekokujo_kimono_2_3, itm_gekokujo_sandal_2]),
        (1,mtef_visitor_source,af_override_everything,0,1,[itm_gekokujo_kimono_3_1, itm_gekokujo_sandal_2]),
        ...
        (3,mtef_visitor_source,af_override_everything,0,1,[itm_gekokujo_kimono_2_1, itm_gekokujo_sandal_2]),
  ...
  (
    ...
    [
      ...
      (32,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[itm_gekokujo_practice_katana]),
      (33,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[itm_gekokujo_practice_katana]),
      (34,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[itm_gekokujo_practice_katana]),
      (35,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[itm_gekokujo_practice_katana]),
      ...
      (41,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[itm_gekokujo_practice_yumi, itm_gekokujo_practice_arrows]),
      (42,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[itm_gekokujo_practice_yumi, itm_gekokujo_practice_arrows]),
      ...
      (61,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[itm_gekokujo_practice_katana]),
      (62,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[itm_gekokujo_practice_katana]),
      (63,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[itm_gekokujo_practice_yumi, itm_gekokujo_practice_arrows]),
      (64,mtef_visitor_source|mtef_team_0,af_override_weapons,aif_start_alarmed,1,[itm_gekokujo_practice_yumi, itm_gekokujo_practice_arrows]),
      ],
    [
      (ti_tab_pressed, 0, 0, [],
       [(try_begin),
...
##         (assign, "$g_tutorial_training_ground_melee_trainer_chamber_completed", 0), #not used
      ...
      (0, 0, ti_once, [],
       [
         ...
         (scene_spawned_item_get_instance, ":item_instance", "itm_gekokujo_practice_yumi", 0),
         ...
         (position_move_z, pos0, -1000, 1),
         (prop_instance_set_position, ":item_instance", pos0),
         (scene_spawned_item_get_instance, ":item_instance", "itm_gekokujo_practice_arrows", 0),
         (prop_instance_get_position, pos0, ":item_instance"),
         (position_move_z, pos0, -1000, 1),
         (prop_instance_set_position, ":item_instance", pos0),
         (scene_spawned_item_get_instance, ":item_instance", "itm_gekokujo_practice_arrows", 0),
         ...
         (position_move_z, pos0, -1000, 1),
         (prop_instance_set_position, ":item_instance", pos0),
         (scene_spawned_item_get_instance, ":item_instance", "itm_gekokujo_practice_kunai", 0),
         (prop_instance_get_position, pos0, ":item_instance"),
         (position_move_z, pos0, -1000, 1),
         (prop_instance_set_position, ":item_instance", pos0),
         (scene_spawned_item_get_instance, ":item_instance", "itm_gekokujo_practice_yari", 0),
         (prop_instance_get_position, pos0, ":item_instance"),
         (position_move_z, pos0, -1000, 1),
         (prop_instance_set_position, ":item_instance", pos0),
         ]),
       ...
       [
         ...
         (try_for_agents, ":cur_agent"),
           ...
           (try_begin),
             ...
             (neq, ":cur_wielded_item", "itm_gekokujo_practice_yumi"),
             (agent_set_wielded_item, ":cur_agent", "itm_gekokujo_practice_yumi"),
           (else_try),
       ...
       [
         ...
         (try_for_agents, ":cur_agent"),
           ...
           (else_try),
             ...
             (try_begin),
               (agent_get_wielded_item, ":cur_wielded_item", ":cur_agent", 0),
               (neq, ":cur_wielded_item", "itm_gekokujo_practice_katana"),
               (agent_set_wielded_item, ":cur_agent", "itm_gekokujo_practice_katana"),
             (else_try),
      ...
      (0, 0, 0,
       [
         ...
         (assign, ":refill", 0),
         (try_begin),
           (eq, ":wielded_weapon", "itm_gekokujo_practice_yumi"),
           (agent_has_item_equipped, ":player_agent", "itm_gekokujo_practice_arrows"),
         ...
         (else_try),
           ...
           (assign, ":refill", 1),
         (else_try),
           (eq, ":wielded_weapon", "itm_gekokujo_practice_kunai"),
           (agent_get_ammo, ":cur_ammo", ":player_agent", 1),
           (le, ":cur_ammo", 1),
           (assign, ":refill", 1),
         (try_end),
       ...
       [
         ...
         (try_begin),
           ...
           (try_begin),
             ...
             (try_end),
             (agent_set_wielded_item, ":trainer_agent", "itm_gekokujo_practice_katana"), #TODO: change this
...
##                 (assign, "$g_tutorial_training_ground_melee_trainer_parry_completed", 1), #not used
         ...
         (try_begin),
           ...
           (eq, ":shield_item", -1),
           (agent_get_wielded_item, ":weapon_item", ":player_agent", 0),
           (neq, ":weapon_item", "itm_gekokujo_practice_wakizashi"),
           (call_script, "script_cf_is_melee_weapon_for_tutorial", ":weapon_item"),
           (store_mission_timer_a, ":cur_time"),
           (gt, ":cur_time", "$g_tutorial_training_ground_next_score_time"),
           (val_add, "$g_tutorial_training_ground_current_score", 1),
...
##         (try_end),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only,af_override_everything,0,1,[itm_gekokujo_katana_1,itm_gekokujo_yumi_1,itm_gekokujo_arrows_1,itm_gekokujo_hakama_1,itm_gekokujo_sandal_1]), #af_override_weapons
     ],
    [
      (ti_tab_pressed, 0, 0, [],
       [(try_begin),
...
##  ),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_tutorial_shield,itm_gekokujo_hakama_1,itm_gekokujo_sandal_1]),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_gekokujo_hakama_1,itm_gekokujo_sandal_1]),
        (3,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_tutorial_staff,itm_gekokujo_hakama_1,itm_gekokujo_sandal_1]), 
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_leader_only|mtef_team_0,af_override_everything,0,1,[itm_gekokujo_katana_1,itm_gekokujo_yumi_1,itm_gekokujo_arrows_1,itm_gekokujo_hakama_1,itm_gekokujo_sandal_1]), #af_override_weapons
     ],
    [
      (ti_tab_pressed, 0, 0, [],
       [(try_begin),
  ...
  (
    ...
    "You enter the training ground.",
    [
        (0,mtef_visitor_source|mtef_team_0,af_override_everything,0,1,[itm_gekokujo_katana_1,itm_gekokujo_yumi_1,itm_gekokujo_arrows_1,itm_tutorial_saddle_horse,itm_gekokujo_hakama_1,itm_gekokujo_sandal_1]),
        (1,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
        (2,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
        (3,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
        (4,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    ...
    [
      ...
      (0, 0, 0, [(try_begin),
                 ...
                 (else_try),
                   ...
                   (reset_visitors),
                   (set_visitor,5,"trp_gekokujo_date_samurai_archer"),
                   (set_visitor,6,"trp_gekokujo_date_samurai_archer"),
                   (set_visitor,7,"trp_gekokujo_date_samurai_archer"),
