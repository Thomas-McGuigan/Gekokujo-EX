   ...
   ("upgrade_path",0,
    ...
    [
        ...
        "{s66}",[
			...
			#gekokujo 3.0 gain 1 relation from every promotion
			(call_script, "script_troop_change_relation_with_troop", "$enlisted_lord", "trp_player", 1),
            (change_screen_map),]),
...
#gekokujo 3.0 freelancer defeat menu start
	(
		"gekokujo_notification_defeated",0,
		"With your commander's defeat, his army has been scattered to the four winds. Your captors have stripped you of your assigned weapons and armor, but hopefully you've hidden away a stash of loot. If you can return to your lord, you will probably be re-equipped.",
		"none",[],
		[("continue",[],"Continue",[(change_screen_return),]),]
	),
#gekokujo 3.0 freelancer defeat menu end
 ]
