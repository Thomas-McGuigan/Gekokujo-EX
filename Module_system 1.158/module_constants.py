...
#diplomacy
slot_faction_truce_days_with_factions_begin 			= 300
slot_faction_provocation_days_with_factions_begin 		= 325
slot_faction_war_damage_inflicted_on_factions_begin 	= 350
slot_faction_sum_advice_about_factions_begin 			= 375
##diplomacy start+ end-points for the ranges for iteration and range checks
slot_faction_truce_days_with_factions_end 			= slot_faction_provocation_days_with_factions_begin
slot_faction_provocation_days_with_factions_end 		= slot_faction_war_damage_inflicted_on_factions_begin
slot_faction_war_damage_inflicted_on_factions_end 	= slot_faction_sum_advice_about_factions_begin
slot_faction_sum_advice_about_factions_end			= 400
##diplomacy end+
...
#gekokujo 3.0 make treaties last 1 week at a time
...
slot_center_shipyards			= 231 #naval stores
...
slto_kingdom_lady       = 6 #Usually inactive (Japan is a traditional place). However, can be made potentially active if active_npcs are expanded to include ladies
...
bandits_end = "trp_northern_warlord"
...
major_kings_begin = kings_begin
major_kings_end = "trp_kingdom_7_lord"

#gekokujo 3.0 microfactions! start
fort_deputies_begin			= "trp_fort_npc_1_1"
fort_deputies_end			= kings_begin

fort_companions_begin		= "trp_fort_npc_1_2"
fort_companions_end			= fort_deputies_begin
#gekokujo 3.0 microfactions! end

companions_begin = "trp_npc1"
#companions_end = kings_begin
companions_end = fort_companions_begin #gekokujo 3.0 microfactions! changes
...
mercenary_troops_begin = "trp_hired_guard"
mercenary_troops_end = "trp_mercenaries_end"

#gekokujo 3.0 ashigaru/samurai re-sorting
ashigaru_troops_begin = "trp_gekokujo_uesugi_villager"
ashigaru_troops_end = "trp_gekokujo_uesugi_jizamurai"
samurai_troops_begin = ashigaru_troops_end
samurai_troops_end = "trp_gekokujo_ikko_monk"
monk_troops_begin = samurai_troops_end
monk_troops_end = "trp_looter"
...
#villages_end   = "p_salt_mine" #gekokujo 3.0 microfactions! changes
villages_end   = "p_fort_1"
...
startup_merchants_begin = "trp_tsu_merchant"
startup_merchants_end = "trp_startup_merchants_end"

##diplomacy start+
tournament_champions_begin = "trp_kaihime"
...
weapons_end = "itm_gekokujo_kanabo_practice"
ranged_weapons_begin = "itm_gekokujo_yumi_1"
ranged_weapons_end = "itm_gekokujo_practice_jo"
armors_begin = "itm_nomad_armor"
armors_end = "itm_items_end"
shields_begin = "itm_gekokujo_practice_jo"
shields_end = "itm_nomad_armor"
...
num_shinano_rebel_spawn_points = 1
num_woku_pirate_spawn_points = 1
num_seto_pirate_spawn_points = 1
num_kanto_rebel_spawn_points = 1
num_northern_raider_spawn_points = 1
num_black_khergit_spawn_points = 1
#gekokujo 3.0 new bandit types
#num_kinai_rebel_spawn_points = 2
num_kinai_rebel_spawn_points = 1
num_monk_rebel_spawn_points = 1
...
#gekokujo 2.1 PBO constants
## Prebattle Orders Begin
slot_party_prebattle_plan              = slot_center_shipyards             #231
slot_party_prebattle_num_orders        = slot_center_household_gardens     #232
slot_party_prebattle_order_array_begin = slot_town_trade_good_prices_begin #250
#Party slots--for the main party only--up to 320 used in this version
#reg()s from 15-50 used in this version (only during presentation)
...
slot_party_cabadrin_order_d1 = slot_town_arena_torny_mission_tpl #79
slot_party_cabadrin_order_d2 = slot_town_arena_melee_1_num_teams #80
slot_party_cabadrin_order_d3 = slot_town_arena_melee_1_team_size #81
slot_party_cabadrin_order_d4 = slot_town_arena_melee_2_num_teams #82
slot_party_cabadrin_order_d5 = slot_town_arena_melee_2_team_size #83
slot_party_cabadrin_order_d6 = slot_town_arena_melee_3_num_teams #84
slot_party_cabadrin_order_d7 = slot_town_arena_melee_3_team_size #85
slot_party_cabadrin_order_d8 = slot_town_arena_melee_cur_tier    #86
...
#Weapon; xx0 not given; xx1 onehand; xx2 twohands; xx3 polearm; xx4 ranged
#At start of battle initialized at 30
...
#gekokujo 2.1a spacing out the provocation slots requires spaced out attitude slots
#dplmc_slot_faction_attitude_begin             = 160
dplmc_slot_faction_attitude_begin             = 400
##diplomacy end
...
#gekokujo 3.0 seafaring
#slot_party_default_icon	=	121 #GOSH DANGIT
seafaring_parties_begin	=	"pt_looters"
seafaring_parties_end	=	"pt_kingdom_1_reinforcements_a" #pt_kingdom_hero_party + 1

#gekokujo 3.0 microfactions! start
spt_fort					= 22
forts_begin 				= "p_fort_1"
forts_end 					= "p_salt_mine"

fort_troops_begin			= "trp_fort_troop_1_1"
fort_troops_end				= "trp_fort_troops_end"

slot_fort_exterior			= slot_town_center #10
slot_fort_type				= slot_town_castle #11
slot_fort_npc_1				= slot_town_elder #25
slot_fort_npc_2				= slot_town_tavernkeeper #20
slot_fort_npc_2_state		= slot_town_weaponsmith #21
#							  #0 = inactive
#							  #1 = asked to join, but not yet joined
#							  #2 = returned home (after defeat, or sent home)
#							  #3 = recruited (might be in party, might be promoted to minister, might be captured)
#							  #4 = promoted to kingdom hero
slot_fort_timer				= slot_village_state #35
slot_fort_fire				= slot_village_smoke_added #38
slot_fort_captured			= slot_village_infested_by_bandits #39
slot_fort_bandit_type		= slot_center_mercenary_troop_type #90
slot_fort_recruit_type		= slot_center_volunteer_troop_type #92
slot_fort_recruit_amount	= slot_center_volunteer_troop_amount #93
