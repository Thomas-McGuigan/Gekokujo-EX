...
##diplomacy end
      ...
      ("camp_gekokujo",[], "Gekokujo-specific options...",
       [
  ...
  ("camp_gekokujo",0,
   ...
   [
	...
	#gekokujo 3.0 companion interaction start (menu option to disable/disable)
      ("gekokujo_disable_companion_quit",[(eq, "$g_gekokujo_companion_neverquit", 0),],"Disable Companion Quitting",[
	      (assign, "$g_gekokujo_companion_neverquit", 1),
	      (jump_to_menu, "mnu_camp_gekokujo"),
        ]),
		
      ("gekokujo_enable_companion_quit",[(eq, "$g_gekokujo_companion_neverquit", 1),],"Enable Companion Quitting",[
	...
	#gekokujo 3.0 cheat menu start
      ("gekokujo_disable_cheat",[(eq, "$cheat_mode", 0),],"Enable Cheat Mode",[
	      (assign, "$cheat_mode", 1),
	      (jump_to_menu, "mnu_camp_gekokujo"),
        ]),
		
      ("gekokujo_enable_cheat",[(eq, "$cheat_mode", 1),],"Disable Cheat Mode",[
	      (assign, "$cheat_mode", 0),
	      (jump_to_menu, "mnu_camp_gekokujo"),
        ]),
   ...
   (
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (else_try),
			  ...
			  (str_store_string, s3, "@Your agents are inside, attempting to open the gates at first opportunity. They expect good news {reg9} hours from now."),
            (try_end),
          (else_try),
            (try_begin),
              (eq, "$g_siege_method", 1),
            ...
            (else_try),
			  ...
			  #gekokujo 3.0 ninja infiltration
              (str_store_string, s3, "@Your agents have opened up the enemy gates."),
            (try_end),
          (try_end),
        (try_end),
    ...
    [
      ...
      ("use_agents",[
       ...
       "Send in agents to open the gates from inside!", [(jump_to_menu,"mnu_send_agents")]),
...
##           (set_battle_advantage, reg0),
 ...
 They expect to take {reg2} hours getting inside and opening the gates.",
    "none",
...
##          ]),
 ...
 In addition to honour, fame and glory, you earn a prize of {reg9} mon. {s8}",
  ...
  (
    "tournament_bet",0,
    "The odds against you are {reg5} to {reg6}.{reg1? You have already bet {reg1} mon on yourself, and if you win, you will earn {reg2} mon.:} How much do you want to bet?",
    "none",
    [
  ...
  (
    ...
    "If you bet {reg1} mon, you will earn {reg2} mon if you win the tournament. Is that all right?",
    "none",
    [
      (call_script, "script_get_win_amount_for_tournament_bet"),
