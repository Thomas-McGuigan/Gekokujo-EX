  ...
  ("game_profile_banner_selection", 0, mesh_load_window, [
    ...
    (ti_on_presentation_event_state_change, [
      ...
      (try_begin),
		...
		#gekokujo 2.1 11 pages of banners?
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (assign, ":cur_troop", "trp_gekokujo_uesugi_mounted_officer"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_2"),
        (assign, ":cur_troop", "trp_gekokujo_date_mounted_officer"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_3"),
        (assign, ":cur_troop", "trp_gekokujo_oda_mounted_officer"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_4"),
        (assign, ":cur_troop", "trp_gekokujo_mori_mounted_officer"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_5"),
        (assign, ":cur_troop", "trp_gekokujo_takeda_mounted_officer"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_6"),
        (assign, ":cur_troop", "trp_gekokujo_tokugawa_mounted_officer"),
      (else_try),
        (assign, ":cur_troop", "trp_kanto_rebel"),
      (try_end),
...
##        (overlay_set_color, reg1, 0),
        ...
        (assign, reg0, ":wealth"),
        (create_text_overlay, reg1, "@Wealth: {reg0} mon", 0),
        (position_set_x, pos1, 750),
        (position_set_y, pos1, 750),
        (overlay_set_size, reg1, pos1),
        (position_set_x, pos1, 600),
        ...
        (create_text_overlay, reg1, "@Inventory: {reg0} mon", 0),
        (position_set_x, pos1, 750),
        (position_set_y, pos1, 750),
        (overlay_set_size, reg1, pos1),
        (position_set_x, pos1, 600),
  ...
  ("world_map", 0, mesh_load_window, [
    (ti_on_presentation_load,
      ...
      ## initialization part begin
        ...
        # world map, X: -384 t0 241  Y: -380 t0 167
        (assign, ":min_map_x", -384*1000),
        (assign, ":max_map_x", 241*1000),
        (assign, ":min_map_y", -380*1000),
        (assign, ":max_map_y", 167*1000),
      ...
      ## initialization part end
        ...
        (try_for_range, ":unused_rows", 0, ":total_rows"),
          (try_for_range, ":unused_cols", 0, ":total_cols"),
            ...
            (try_begin),
			  ...
			  (eq, ":current_terrain", rt_bridge), #gekokujo 3.0 seafaring don't count fords!
              (assign, ":dest_color", 0xFFFFFF), # default
            (else_try),
			...
			#gekokujo 3.0 nevermind on the map borders start
            ...
            #      (neq, ":current_terrain", rt_bridge), #gekokujo 3.0 seafaring don't count fords!
            #      (neq, ":current_terrain_2", rt_bridge), #gekokujo 3.0 seafaring don't count fords!
            #      (call_script, "script_get_closest_center", "p_temp_party"),
            ...
            #      (this_or_next|eq, ":current_terrain", rt_bridge), #gekokujo 3.0 seafaring don't count fords!
            #      (eq, ":current_terrain_2", rt_bridge), #gekokujo 3.0 seafaring don't count fords!
            #      (assign, ":continue", 1),
            #    (try_end),
            #    (eq, ":continue", 1),
            #    (create_mesh_overlay, reg0, "mesh_white_plane"),
        ...
        (position_set_x, pos1, 790), #790
        (position_set_y, pos1, 700), #700
        (overlay_set_position, reg0, pos1),
        
        (assign, ":pos_x", 750), #750
        (assign, ":pos_y", 650), #650
        (try_for_range, ":cur_kingdom", kingdoms_begin, kingdoms_end),
          ...
          (overlay_set_position, reg0, pos1),
          # size: 25*20
          (position_set_x, pos1, 25*50),
          (position_set_y, pos1, 20*50),
          (overlay_set_size, reg0, pos1),
          # kingdom name
          (store_add, ":text_x", ":pos_x", 30),
          (store_add, ":text_y", ":pos_y", 9),
      ...
      [
        ...
        (try_begin),
          ...
          (try_for_range, ":slot_no", 0, "$temp"),
            ...
            (store_mul, ":overlay_display", ":value", 0xFF),
            (overlay_set_alpha, ":cur_overlay", ":overlay_display"),
          (try_end),
        (else_try),
      ...
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
        ...
        (try_begin),
          ...
          (position_set_x, pos1, 400), #350 ; 380
          (overlay_set_position, "$g_presentation_but0_riding", pos1),
          (position_set_x, pos1, 570), #475 ; 500
        ...
        (position_set_x, pos1, 340), #290 ; 320
		(val_add, ":y_position_for_order_buttons", -35),
        (position_set_y, pos1, ":y_position_for_order_buttons"),
        (overlay_set_position, "$g_presentation_obj_battle_11", pos1),
		...
		(position_set_x, pos1, 355), #315
        (position_set_y, pos1, ":y_position_for_order_buttons"),
		(overlay_set_position, reg(51), pos1),		
		(position_set_x, pos1, 520), #437
        ...
        (position_set_x, pos1, 510), #410 ; 450
        (position_set_y, pos1, ":y_position_for_order_buttons"),
        (overlay_set_position, "$g_presentation_obj_battle_12", pos1),
       ...
       [(store_trigger_param_1, ":object"),
        ...
        (else_try),
          ...
          (else_try),         
			...
			(call_script, "script_prebattle_order_update_text_slot", 3, 0, 0),
          (else_try),
            (eq, ":value", 2),
			#(str_store_string, s1, "@Blunt Weapons"),
			(call_script, "script_prebattle_order_update_text_slot", 3, 9, 0),
          (try_end),
		(else_try), 
          (eq, ":object", "$g_presentation_obj_battle_14"),
		  (try_begin),
		...
		(else_try), 
          ...
          (else_try),
			...
			(call_script, "script_prebattle_order_update_text_slot", 5, 4, 0),
          (else_try),
            (eq, ":value", 0),
			#(str_store_string, s1, "@No Shields"),
			(call_script, "script_prebattle_order_update_text_slot", 5, 5, 0),
          (try_end),
		(else_try), 
          (eq, ":object", "$g_presentation_obj_battle_16"),
		  (try_begin),
