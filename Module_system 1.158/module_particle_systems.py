...
##    
 ...
 #   ),
    ...
    ("gekokujo_shoot_smoke", psf_billboard_3d|psf_randomize_size, "prtcl_dust_a",
	#gekokujo 3.0 longer-lasting smoke
     #90, 2.5, 0.6, -0.2, 60.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
	 180, 5, 0.6, -0.1, 60.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.75), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
     (0, 1.5),   (0.5, 11.0),   #scale keys
	 #gekokujo 3.0 more smoke
     #(0.1, 0.1, 0.1),           #emit box size
     (0.1, 0.2, 0.1),           #emit box size
	 #gekokujo 3.0 smoke goes forward
     #(2, 2, 0),                 #emit velocity
     (0, 1.5, 0),                 #emit velocity
     0.1                        #emit dir randomness
    ),
	
    ("gekokujo_hit_smoke", psf_billboard_3d|psf_randomize_size, "prtcl_dust_a",
     60, 2.5, 0.6, -0.1, 60.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strengt
     (0.0, 0.75), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
