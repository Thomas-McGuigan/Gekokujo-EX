...
##  ),
 ...
 ("bring_back_runaway_serfs", "Bring Back Runaway Peasants", qf_random_quest,
  "{!}{s9} asked you to bring back the three groups of runaway peasants back to {s2}. He said all three groups must be running away in the direction of {s3}."
  ),
 ...
 ("collect_debt", "Collect the Debt {s3} Owes to {s9}", qf_random_quest,
  "{!}{s9} asked you to collect the debt of {reg4} mon {s3} owes to him."
  ),
...
# Note : This is defined as lord quests end in module_constants.py:
 ...
 ("report_to_army", "Report to {s13}, the strategist", qf_random_quest,
  "{!}None"
  ),
...
# Gekokujo "deliver cattle" is now "deliver rice"
 ("deliver_cattle_to_army", "Deliver {reg3} Sacks of white rice to {s13}", qf_random_quest,
  "{!}None"
  ),
...
# Note : This is defined as the first mayor quest in module_constants.py: 
 ("move_cattle_herd", "Move Cattle Herd to {s13}", qf_random_quest,
  "{!}The chief merchant of {s10} asked you to move a cattle herd to {s13}."
  ),
 ...
 ("deliver_wine", "Deliver {reg5} Units of {s6} to {s4}", qf_random_quest,
  "{!}{s9} of {s3} asked you to deliver {reg5} units of {s6} to the inn at {s4} in 7 days."
  ),
 ...
 ("kidnapped_girl", "Ransom Girl from Bandits", qf_random_quest,
  "{!}The chief merchant of {s4} gave you {reg12} mon to pay the ransom of a girl kidnapped by bandits.\
 ...
 ("persuade_lords_to_make_peace", "Make Sure Two Lords Do Not Object to Peace", qf_random_quest, #possibly deprecate., or change effects
  "{!}The chief merchant of {s4} promised you {reg12} mon if you can make sure that\
 ...
 ("deal_with_looters", "Deal with Looters", qf_random_quest,
  "{!}The chief merchant of {s4} has asked you to deal with several bands of looters around {s4}, and bring back any goods you recover."
  ),
 ("deal_with_night_bandits", "Deal with Night Bandits", qf_random_quest,
  "{!}TODO: The chief merchant of {s14} has asked you to deal with night bandits at {s14}."
  ),
...
# Note : This is defined as the first village elder quest in module_constants.py:
 ("deliver_grain", "Bring brown rice to {s3}", qf_random_quest,
  "{!}The elder of the village of {s3} asked you to bring them {reg5} sacks of brown rice.."
  ), 
...
##     ),
 ...
 # Join Kingdom quest
  ("join_faction", "Give Oath of Loyalty to {s1}", qf_random_quest,
  "{!}Find {s1} and give him your oath of loyalty."
  ),

 # Rebel against Kingdom quest
 ("rebel_against_kingdom", "Help {s13} Claim the Overlordship of {s14}", qf_random_quest,
  "{!}None"
  ),
 ...
 ("raid_caravan_to_start_war", "Attack a Neutral Caravan to Provoke War", qf_random_quest,
  ...
  ("cause_provocation", "Give a Domain Provocation to Attack Another", qf_random_quest,
  "{!}placeholder",
 ...
 ("collect_men", "Collect Five Men", 0,
  "{!}{s9} asked you to collect at least 5 men before you move against the bandits threatening the townsmen. You can recruit soldiers from villages as well as town inns. You can find {s9} at the inn at {s4} when you have think you have enough men."
  ), 
  
  ("learn_where_merchant_brother_is", "Learn Where Horenbo is Held.", 0,
  "{!}placeholder."
  ), 
  
  ("save_relative_of_merchant", "Attack the Samurai Mansion", 0,
  "{!}placeholder."
  ),   

  ("save_town_from_bandits", "Cleanse the town in the name of Amida Buddha", 0,
  "{!}placeholder."
  ),   
