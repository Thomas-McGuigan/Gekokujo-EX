  ...
  ("taragoth_lords_report", 0, mesh_load_window, [
	...
	[
		...
		(try_begin),
			...
			#gekokujo 3.0 slow down freelancer advancement start
			(val_mul, reg0, 5),
			#gekokujo 3.0 slow down freelancer advancement end
		...
		#gekokujo 3.0 display new pay rates for monks and samurai start
		##pays player 10 times the troop level
		#(store_mul, ":weekly_pay", 10, ":level"),
		(try_begin),
			(is_between, "$player_cur_troop", monk_troops_begin, monk_troops_end),
			(assign, ":weekly_pay", 0),
		(else_try),
			(is_between, "$player_cur_troop", samurai_troops_begin, samurai_troops_end),
			(store_mul, ":weekly_pay", 20, ":level"),
		(else_try),
			(store_mul, ":weekly_pay", 10, ":level"),
		(try_end),
		#gekokujo 3.0 display new pay rates for monks and samurai end
		
		(assign, reg23, ":weekly_pay"),
		(create_text_overlay, reg0, "@Current Wage: {reg23} mon.", tf_left_align),
		(position_set_y, pos1, ":cur_y"),
		(overlay_set_position, reg0, pos1),
		(val_sub, ":cur_y", ":cur_y_adder"),
		...
		(try_begin),
			...
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_uesugi"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_2"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_date"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_3"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_oda"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_4"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_mori"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_5"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_takeda"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_6"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_tokugawa"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_7"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_miyoshi"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_8"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_amako"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_9"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_otomo"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_10"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_nanbu"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_11"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_asakura"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_12"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_chosokabe"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_13"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_hojo"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_14"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_mogami"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_15"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_shimazu"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_16"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_ryuzoji"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_17"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_satake"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_18"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_satomi"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_19"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_ukita"),
		(else_try),
			(eq, ":cmdr_faction","fac_kingdom_20"),
			(create_mesh_overlay, reg0, "mesh_gekokujo_pic_arms_ikko"),
		(try_end),
